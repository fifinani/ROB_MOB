...
if("FALSE" STREQUAL "TRUE")
  set(eigen_conversions_SOURCE_PREFIX /home/kartick/ROB_MOB/catkin_ws/src/geometry-indigo-devel/eigen_conversions)
  set(eigen_conversions_DEVEL_PREFIX /home/kartick/ROB_MOB/catkin_ws/devel)
...
if(NOT "include;/usr/include/eigen3;/opt/ros/kinetic/share/orocos_kdl/../../include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eigen_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  ${_report}")
    endif()
